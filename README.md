...
### [1. Исследование объявлений о продаже квартир](/estate_sale_analysis)
...
### [2. Тарифные планы (телеком)](/analysis_of_profitable_telecom_tariff_plan)
...
### [3. Исследование игровых платформ](/predicting_the_success_of_new_game)
...
### [4. Рекомендация тарифов (телеком)](/recommendation_model_of_new_tariff_plan)
...
### [5. Прогнозирование оттока клиентов банка](/bank_customer_churn_prediction)
...
### [6. Определение наиболее выгодного региона нефтедобычи](/predicting_new_profitable_oil_field)
...
### [7. Восстановление золота из руды](/predicting_gold_recovery_from_rougher)
...
### [8. Защита персональных данных клиентов](/protecting_personal_info)
...
### [9. Определение стоимости автомобилей](/car_price_prediction)
...
### [10. Прогнозирование заказов такси](/predicting_taxi_orders)
...
### [11. Классификация комментариев](/classifying_comments)
...
### [12. Определение возраста покупателей](/age_prediction_by_photo)
...
### [13. Прогнозирование оттока клиентов (телеком)](/predicting_user_churn_final_project)
